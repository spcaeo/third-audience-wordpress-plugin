			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Fieldcamp</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Fieldcamp</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>KML File</h1>
															...
															<p>
									This KML File is generated by Fieldcamp. It is used to provide location information to Google.								</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>XML Sitemap</h1>
															...
															<p>
									This XML Sitemap is generated by Fieldcamp . It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.								</p>
