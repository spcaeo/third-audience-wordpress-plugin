...
export const metadata: Metadata = {
  title: 'Cleaning Software | FieldCamp 2025',
  description: 'The best cleaning software for managing your cleaning business',
  robots: 'noindex, nofollow',
  alternates: {
    canonical: 'https://fieldcamp.ai/cleaning-software/'
  }
};
...
export default function CleaningSoftwarePage() {
    ...
    <div className="new-ppc-template">
      ...
      <section className='hero-section-ppc-ln py-[50px] md:py-[70px] lg:py-[90px]'>
        <div className='container max-w-[1245px] mx-auto px-[15px] lg:px-15px'>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mobile-clmn">

            {/* Left Content */}
            <div className="space-y-6">
              <h1 className="text-[32px] md:text-[42px] lg:text-[52px] leading-[1.15] font-bold">
                Book 47% More Cleaning Jobs <br />
                With 73% Less Admin Work
              </h1>

              <p className="text-[18px] md:text-[20px] leading-relaxed max-w-[500px] text-gray-600">
                Join 500+ cleaning companies saving 10 hours/week on scheduling, quoting, and invoicing
              </p>
              ...
              <div className="space-y-3 max-w-[500px]">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[16px] md:text-[18px] font-medium">Quote any job in 38 seconds</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-[16px] md:text-[18px] font-medium">Route 12 techs across 47 stops automatically</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-[16px] md:text-[18px] font-medium">Invoice before you leave the driveway</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-[16px] md:text-[18px] font-medium">Know your chemical inventory in real-time</span>
                </div>
              </div>
            ...
            <div className="relative hidden md:flex">
              <img
                src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/clienti-sofdtware-banner-img.png"
                alt="vertex"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center logo-new-ppc-sec">
            ...
            <div className="order-1 lg:order-1 lg:col-span-5 mobile-clmn">
              <h2 className="text-[24px] md:text-[36px] lg:text-[32px] font-semibold md:font-bold leading-[1.3] md:leading-[1.2] mb-8 md:mb-0 text-center lg:text-left">
                Why cleaning companies <br className="" />
                choose FieldCamp
              </h2>
            </div>
            ...
            <div className="order-2 lg:order-2 lg:col-span-7 mobile-clmn">
              <div className="md:flex flex-row items-center justify-between gap-6 md:gap-6 lg:gap-8 logo-new-bx">
                <div className="flex items-center justify-center flex-1">
                  <img
                    src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/clen-logo-1.png"
                    alt="greenedge"
                ...
                <div className="flex items-center justify-center flex-1">
                  <img
                    src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/clen-logo-2.png"
                    alt="lawnlift"
                    className="h-[50px] md:h-[60px] w-auto object-contain"
                  />
                </div>
                ...
                <div className="flex items-center justify-center flex-1">
                  <img
                    src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/clen-logo-3.png"
                    alt="grass-ctraft"
                    className="h-[50px] md:h-[60px] w-auto object-contain"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mobile-clmn">
            ...
            <div className="text-center client-bx">
              ...
              <h3 className="text-[20px] md:text-[24px] font-bold mb-4">
                Upload your client list or connect QuickBooks
              </h3>
              <p className="text-[14px] md:text-[16px] text-gray-500">
                112 cleaning companies imported in under 5 minutes
              </p>
            </div>
            ...
            <div className="text-center client-bx">
              ...
              <h3 className="text-[20px] md:text-[24px] font-bold mb-4">
                Drag jobs onto your team's calendar
              </h3>
              <p className="text-[14px] md:text-[16px] text-gray-500">
                Average user schedules 50 jobs in first session
              </p>
            </div>
            ...
            <div className="text-center client-bx">
              <div className="mb-6">
                <img
                  src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/bussiness-step-3.svg"
                  alt="grass-ctraft"
                  className=""
                />
              </div>
              <h3 className="text-[20px] md:text-[24px] font-bold mb-4">
                Auto-invoice when jobs complete
              </h3>
              <p className="text-[14px] md:text-[16px] text-gray-500">
                $12,291 average first month revenue tracked
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 feature-section-bx mobile-clmn">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-[18px] md:text-[18px] leading-relaxed max-w-[320px] mx-auto">
                Client preferences sync to phones instantly. Cleans trigger invoices automatically. One Profile: codes, pets, allergies.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-[20px] md:text-[24px] font-bold">
                Built for Cleaning reality
              </h3>
              <p className="text-[18px] md:text-[18px] leading-relaxed max-w-[320px] mx-auto">
                Handles weekly, monthly, one-time moves. Special instructions travel with every job Teams stay in zones—no more crossing town.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-[18px] md:text-[18px] leading-relaxed max-w-[320px] mx-auto">
                Cleaners need no training, just maps. Move jobs between teams for sick calls. Check what happens before confirming.
              </p>
            </div>
        ...
        <div className='container max-w-[1245px] mx-auto px-[15px] lg:px-[15px]'>
          ...
          <div className="mb-16">
            ...
            <p className="text-[18px] md:text-[18px] leading-relaxed max-w-[600px] mx-auto text-center text-gray-600">
              We focus exclusively on AI features that transform how your cleaning business operates. Here's what sets us apart:
            </p>
          </div>
          ...
          <div className="desc-bx-recept bg-gray-50 border border-gray-200 rounded-2xl">
                ...
                <div className="recpt-body-desc">
                  ...
                  <ul className="space-y-3 text-[16px] leading-relaxed text-gray-700 mb-8">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>Handles "Is Tuesday at 2pm available?"</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>Knows your pricing & availability instantly</span>
                    </li>
                  </ul>
                </div>
              ...
              <div className='recpt-right-bx bx-flex'>
                <img
                  src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/ai-rececptionist.svg"
                  alt="Simple to Trust"
            ...
            <div className="desc-bx-recept bg-gray-50 border border-gray-200 rounded-2xl">
                ...
                <div className="recpt-body-desc">
                  ...
                  <ul className="space-y-3 text-[16px] leading-relaxed text-gray-700 mb-8">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>"Book Your Cleaning" with calendar</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>"3 bookings while you were busy"</span>
                    </li>
                  </ul>
                </div>
                <div className='recpt-link-btn'>
              ...
              <div className='recpt-right-bx bx-flex'>
                <img
                  src="https://cms.fieldcamp.ai/wp-content/uploads/2025/09/schdule-mach-1.png"
                  alt="Simple to Trust"
                  className="m-auto text-center"
                ...
                <div className="recpt-body-desc">
                  ...
                  <ul className="space-y-3 text-[16px] leading-relaxed text-gray-700 mb-8">
                    <li className="flex items-start gap-3">
                      ...
                      <span>"Which clients haven't booked in 60 days?"</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>"Can you create an invoice for..."</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>"Schedule a cleaning job for..."</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>"Who is my best performing tech?"</span>
                    </li>
                  </ul>
                </div>
                <div className='recpt-link-btn'>
                ...
                <div className="space-y-6 p-6">
                  ...
                  <ul className="space-y-3 text-[16px] leading-relaxed text-gray-700 mb-8" style={{marginLeft: "15px"}}>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>Books directly into your calendar</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-2xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start h-full mobile-clmn items-center">
                ...
                <img
                  ...
                  alt="Simple to Trust"
                  className="w-full h-full"
                  style={{ backgroundColor: "#EDEDED", padding: "35px" }}
                />
              </div>
            </div> */}
      ...
      <section className='cta-ppc-new-section pt-160'>
        <div className='container max-w-[1245px] mx-auto px-[15px] lg:px-[15px]'>
          <div className="relative bg-gray-100 rounded-3xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center cta-new-ppc-bx mobile-clmn">
              ...
              <div className="space-y-6 order-1 lg:order-1">
                ...
                <div className="btn-cta-new-ppc">
                  <a href='https://calendly.com/jeel-fieldcamp/30min' className="calendly-open bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-xl font-medium hover:opacity-90 transition-opacity">Book a Demo</a>
                </div>
              </div>
