...
export default function LawnCareExitIntentPopup() {
  ...
  const lossBreakdown = [
    { label: 'Inefficient crew routing', amount: 1650 },
    { label: 'Missed estimate calls', amount: 1420 },
    { label: 'Manual scheduling errors', amount: 890 },
    { label: 'Late invoices & payments', amount: 580 }
  ];
      ...
      {currentStep === 1 && (
        <div className="bg-white rounded-2xl p-12 max-w-2xl w-full text-center border border-gray-200">
          <h2 className="text-[26px] md:text-[30px] lg:text-[32px] font-bold leading-[1.3] text-gray-900 mb-6">
            Your Lawn Care Business is Losing
          </h2>
          <div className="mb-6">
        ...
        <div className="bg-white rounded-2xl p-12 max-w-4xl w-full text-center border border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="calendly-open bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-xl font-medium hover:opacity-90 transition-opacity shadow-lg"
              onClick={closePopup}
            >
