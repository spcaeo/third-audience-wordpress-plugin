...
const GeneratedInvoice = ({ data, companyLogo, calculations }: GeneratedInvoiceProps) => {
  return (
...
export default function InvoiceGenerator({ preFilledData }: { preFilledData?: InvoiceData['preFilledData'] }) {
