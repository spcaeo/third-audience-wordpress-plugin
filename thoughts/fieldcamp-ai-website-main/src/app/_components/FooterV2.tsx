          ...
          <div className="footer-features-grid flex flex-wrap justify-center lg:justify-between gap-2 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-12 text-center">
            <div className="footer-feature-item flex items-center gap-1 sm:gap-2 pr-4 sm:pr-8 md:pr-10 lg:pr-12 xl:pr-14 relative">
              <svg className="footer-feature-icon w-3 h-3 sm:w-4 sm:h-4 text-gray-600 flex-shrink-0" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.11646 6V3H6.11646" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M13.6165 6H4.61646C3.78803 6 3.11646 6.67157 3.11646 7.5V13.5C3.11646 14.3284 3.78803 15 4.61646 15H13.6165C14.4449 15 15.1165 14.3284 15.1165 13.5V7.5C15.1165 6.67157 14.4449 6 13.6165 6Z" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M1.61646 10.5H3.11646" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M15.1165 10.5H16.6165" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M11.3665 9.75V11.25" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M6.86646 9.75V11.25" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            ...
            <div className="footer-feature-item flex items-center gap-1 sm:gap-2 pr-4 sm:pr-8 md:pr-10 lg:pr-12 xl:pr-14 relative">
              <svg className="footer-feature-icon w-3 h-3 sm:w-4 sm:h-4 text-gray-600 flex-shrink-0" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.61496 15.3637C6.29924 14.8982 5.16017 14.0363 4.35455 12.8967C3.54894 11.757 3.11639 10.3956 3.11646 9C3.11646 8.11358 3.29105 7.23583 3.63027 6.41689C3.96949 5.59794 4.46669 4.85382 5.09348 4.22703C5.72028 3.60023 6.46439 3.10303 7.28334 2.76381C8.10229 2.42459 8.98003 2.25 9.86646 2.25C10.7529 2.25 11.6306 2.42459 12.4496 2.76381C13.2685 3.10303 14.0126 3.60023 14.6394 4.22703C15.2662 4.85382 15.7634 5.59794 16.1026 6.41689C16.4419 7.23583 16.6165 8.11358 16.6165 9" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M9.86646 5.25V9" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M9.86646 11.25H11.3665C11.5654 11.25 11.7561 11.329 11.8968 11.4697C12.0374 11.6103 12.1165 11.8011 12.1165 12V12.75C12.1165 12.9489 12.0374 13.1397 11.8968 13.2803C11.7561 13.421 11.5654 13.5 11.3665 13.5H10.6165C10.4175 13.5 10.2268 13.579 10.0861 13.7197C9.94547 13.8603 9.86646 14.0511 9.86646 14.25V15C9.86646 15.1989 9.94547 15.3897 10.0861 15.5303C10.2268 15.671 10.4175 15.75 10.6165 15.75H12.1165" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M14.3665 11.25V12.75C14.3665 12.9489 14.4455 13.1397 14.5861 13.2803C14.7268 13.421 14.9175 13.5 15.1165 13.5H15.8665" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M16.6165 11.25V15.75" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            ...
            <div className="footer-feature-item flex items-center gap-1 sm:gap-2 pr-4 sm:pr-8 md:pr-10 lg:pr-12 xl:pr-14 relative">
              <svg className="footer-feature-icon w-3 h-3 sm:w-4 sm:h-4 text-gray-600 flex-shrink-0" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_6202_9863)">
                  ...
                  <g mask="url(#mask0_6202_9863)">
                    <path d="M5.18403 9.96068H7.50153V15.3607C7.50153 16.6207 8.18403 16.8757 9.01653 15.9307L14.694 9.48068C15.3915 8.69318 15.099 8.04068 14.0415 8.04068H11.724V2.64066C11.724 1.38066 11.0415 1.12566 10.209 2.07066L4.53153 8.52068C3.84153 9.31568 4.13403 9.96068 5.18403 9.96068Z" stroke="black" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                </g>
                <defs>
            ...
            <div className="footer-feature-item flex items-center gap-1 sm:gap-2 pr-4 sm:pr-8 md:pr-10 lg:pr-12 xl:pr-14 relative">
              <svg className="footer-feature-icon w-3 h-3 sm:w-4 sm:h-4 text-gray-600 flex-shrink-0" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_6202_9872)">
                  ...
                  <g mask="url(#mask0_6202_9872)">
                    <path d="M4.86621 7.5V6C4.86621 3.5175 5.61621 1.5 9.36621 1.5C13.1162 1.5 13.8662 3.5175 13.8662 6V7.5" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M9.36621 13.875C10.4017 13.875 11.2412 13.0355 11.2412 12C11.2412 10.9645 10.4017 10.125 9.36621 10.125C8.33069 10.125 7.49121 10.9645 7.49121 12C7.49121 13.0355 8.33069 13.875 9.36621 13.875Z" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M13.1162 16.5H5.61621C2.61621 16.5 1.86621 15.75 1.86621 12.75V11.25C1.86621 8.25 2.61621 7.5 5.61621 7.5H13.1162C16.1162 7.5 16.8662 8.25 16.8662 11.25V12.75C16.8662 15.75 16.1162 16.5 13.1162 16.5Z" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                </g>
                <defs>
            ...
            <div className="footer-feature-item flex items-center gap-1 sm:gap-2">
              <svg className="footer-feature-icon w-3 h-3 sm:w-4 sm:h-4 text-gray-600 flex-shrink-0" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.11621 10.5L12.1162 7.5" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M2.62121 14.2503C1.96287 13.1102 1.61626 11.8168 1.61621 10.5003C1.61616 9.18373 1.96268 7.89035 2.62093 6.75016C3.27917 5.60998 4.22596 4.66315 5.36613 4.00486C6.50629 3.34656 7.79965 3 9.11621 3C10.4328 3 11.7261 3.34656 12.8663 4.00486C14.0065 4.66315 14.9532 5.60998 15.6115 6.75016C16.2697 7.89035 16.6163 9.18373 16.6162 10.5003C16.6162 11.8168 16.2695 13.1102 15.6112 14.2503" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
      ...
      <footer className="footer-main-section bg-white">
        <div className="footer-main-container max-w-[1246px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-6 py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16">
          <div className="footer-columns-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 md:gap-8 lg:gap-6 xl:gap-8">
            ...
            {/* Resources Column */}
            <div className="footer-column footer-column-resources space-y-2 sm:space-y-3 lg:space-y-4">
              <h3 className="footer-column-title text-[14px] font-medium text-[#000000]">Resources</h3>
              <div className="footer-column-links space-y-1 sm:space-y-2 lg:space-y-3 text-sm">
                <Link href="/invoice-templates" className="footer-link block text-gray-600 hover:text-gray-900">Invoice Templates</Link>
                <Link href="/estimate-templates" className="footer-link block text-gray-600 hover:text-gray-900">Estimate Templates</Link>
              </div>
            </div>

            {/* Help Center Column */}
            <div className="footer-column footer-column-help space-y-2 sm:space-y-3 lg:space-y-4">
              <h3 className="footer-column-title text-[14px] font-medium text-[#000000]">Help Center</h3>
              <div className="footer-column-links space-y-1 sm:space-y-2 lg:space-y-3 text-sm">
                <Link href="/demo" className="footer-link block text-gray-600 hover:text-gray-900">On-Demand Demo</Link>
                <Link href="/academy" className="footer-link block text-gray-600 hover:text-gray-900">FieldCamp Academy</Link>
                <Link href="/templates" className="footer-link block text-gray-600 hover:text-gray-900">Templates Library</Link>
                <Link href="/support" className="footer-link block text-gray-600 hover:text-gray-900">Contact Support</Link>
              </div>
            </div>

            {/* Features Column */}
            <div className="footer-column footer-column-features space-y-2 sm:space-y-3 lg:space-y-4">
              <h3 className="footer-column-title text-[14px] font-medium text-[#000000]">Features</h3>
              <div className="footer-column-links space-y-1 sm:space-y-2 lg:space-y-3 text-sm">
                <Link href="/ai-command-center" className="footer-link block text-gray-600 hover:text-gray-900">AI Command Center</Link>
                <Link href="/job-scheduling" className="footer-link block text-gray-600 hover:text-gray-900">Job Scheduling</Link>
                <Link href="/dispatch" className="footer-link block text-gray-600 hover:text-gray-900">Dispatch Management</Link>
                <Link href="/customer-portal" className="footer-link block text-gray-600 hover:text-gray-900">Customer Portal</Link>
                <Link href="/mobile-apps" className="footer-link block text-gray-600 hover:text-gray-900">Mobile Apps</Link>
                <Link href="/invoicing" className="footer-link block text-gray-600 hover:text-gray-900">Invoicing & Payments</Link>
                <Link href="/route-optimization" className="footer-link block text-gray-600 hover:text-gray-900">Route Optimization</Link>
                <Link href="/inventory" className="footer-link block text-gray-600 hover:text-gray-900">Inventory Management</Link>
                <Link href="/analytics" className="footer-link block text-gray-600 hover:text-gray-900">Analytics & Reports</Link>
              </div>
            </div>

            {/* Compare Column */}
            <div className="footer-column footer-column-compare space-y-2 sm:space-y-3 lg:space-y-4">
              <h3 className="footer-column-title text-[14px] font-medium text-[#000000]">Compare</h3>
              <div className="footer-column-links space-y-1 sm:space-y-2 lg:space-y-3 text-sm">
                <Link href="/vs-jobber" className="footer-link block text-gray-600 hover:text-gray-900">vs Jobber</Link>
                <Link href="/vs-housecall-pro" className="footer-link block text-gray-600 hover:text-gray-900">vs Housecall Pro</Link>
                <Link href="/vs-guerilladesk" className="footer-link block text-gray-600 hover:text-gray-900">vs Guerilladesk</Link>
              </div>
            </div>

            {/* Learn & Connect Column */}
            <div className="footer-column footer-column-learn-connect space-y-4 sm:space-y-5 lg:space-y-6">
              <div className="footer-learn-section space-y-1 sm:space-y-2">
                <h3 className="footer-column-title text-[14px] font-medium text-[#000000]">Learn</h3>
                <div className="footer-column-links space-y-1 sm:space-y-2 lg:space-y-3 text-sm">
                  <Link href="/blog" className="footer-link block text-gray-600 hover:text-gray-900">Blog</Link>
                  <Link href="/alternatives" className="footer-link block text-gray-600 hover:text-gray-900">Alternatives</Link>
                  <Link href="/reviews" className="footer-link block text-gray-600 hover:text-gray-900">Reviews</Link>
                </div>
              </div>

              <div className="footer-connect-section space-y-2 sm:space-y-3 lg:space-y-3">
                ...
                <div className="footer-social-links flex space-x-2 sm:space-x-3 lg:space-x-3">
                  <Link href="https://www.linkedin.com/company/fieldcamp/" className="footer-social-link text-gray-400 hover:text-gray-500">
                    <svg className="footer-social-icon w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_6202_9937)">
                  ...
                  <Link href="https://www.facebook.com/getfieldcamp" className="footer-social-link text-gray-400 hover:text-gray-500">
                    <svg className="footer-social-icon w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_6202_9940)">
                  ...
                  <Link href="https://www.instagram.com/fieldcamp.ai/" className="footer-social-link text-gray-400 hover:text-gray-500">
                    <svg className="footer-social-icon w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_6202_9947)">
                        ...
                        <circle cx="12.1472" cy="12.0315" r="4.26196" stroke="#232529" stroke-width="1.5" />
                      </g>
                      <defs>
                  ...
                  <Link href="https://www.youtube.com/@fieldcamp_ai" className="footer-social-link text-gray-400 hover:text-gray-500">
                    <svg className="footer-social-icon w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_6202_9951)">
                  ...
                  <Link href="https://x.com/FieldCamp_ai" className="footer-social-link text-gray-400 hover:text-gray-500">
                    <svg className="footer-social-icon w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_6202_9956)">
          ...
          {/* App Store Badges & Bottom Section */}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-6">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start">
                <Link href="https://apps.apple.com/us/app/fieldcamp/id6737540187" target="_blank" className="footer-app-store-link">
                  <Image src="https://cms.fieldcamp.ai/wp-content/uploads/2025/08/app-store-im.png" alt="Download on App Store" width={120} height={36} className="footer-app-store-badge sm:w-[130px] sm:h-[39px] lg:w-[140px] lg:h-[42px]" />
                </Link>
                <Link href="https://play.google.com/store/apps/details?id=com.fieldcampai.app" target="_blank" className="footer-google-play-link">
                  <Image src="https://cms.fieldcamp.ai/wp-content/uploads/2025/08/play-store-im.png" alt="Get it on Google Play" width={120} height={36} className="footer-google-play-badge sm:w-[130px] sm:h-[39px] lg:w-[140px] lg:h-[42px]" />
                </Link>
              </div>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 lg:gap-8 text-sm text-gray-600">
                ...
                <div className="footer-bottom-links flex gap-4 sm:gap-6">
                  <Link href="/privacy" className="footer-bottom-link hover:text-gray-900">Privacy</Link>
                  <Link href="/terms" className="footer-bottom-link hover:text-gray-900">Terms</Link>
                  <Link href="/security" className="footer-bottom-link hover:text-gray-900">Security</Link>
                </div>
              </div>
            </div>
          </div>
