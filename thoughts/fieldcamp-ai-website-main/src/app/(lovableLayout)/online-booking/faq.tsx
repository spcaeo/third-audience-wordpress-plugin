  ...
  return (
   <div className="max-w-4xl mx-auto bg-white">
     <div className="text-center mb-8 md:mb-16">
       ...
       <p className="mt-3 md:mt-6 text-base md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">Everything you need to know about getting started with online booking</p>
     </div>
